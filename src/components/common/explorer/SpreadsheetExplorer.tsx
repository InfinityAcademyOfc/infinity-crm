...
import { DocumentProvider } from "../../../components/production/document-explorer/contexts/DocumentContext";
import DocumentExplorer from "../../../components/production/document-explorer/DocumentExplorer";
import { DocumentItem } from "../../../components/production/document-explorer/types";
...
const SpreadsheetExplorer: React.FC<SpreadsheetExplorerProps> = ({
  onSelectFile,
  selectedFile
}) => {
