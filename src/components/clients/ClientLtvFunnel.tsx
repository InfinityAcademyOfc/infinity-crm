...
const ClientLtvFunnel = () => {
  ...
  return <div className="space-y-4">
      <SectionHeader title="Funil de Valor do Cliente (LTV)" description="Visualize e gerencie o ciclo de vida e valor de seus clientes" actions={<Button variant="outline" size="sm">
