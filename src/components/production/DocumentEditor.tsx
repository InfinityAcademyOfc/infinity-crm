  ...
  return <div className="h-full border rounded-lg overflow-hidden" style={{
    height: '842px'
      ...
      <ResizablePanelGroup direction="horizontal" className="h-full">
        ...
        <ResizablePanel>
          {selectedFile ? <DocumentContent initialContent={selectedFile.content || ""} onContentChange={handleContentChange} documentId={selectedFile.id} /> : <div className="h-full flex items-center justify-center text-gray-500 dark:text-gray-400 bg-gray-950">
