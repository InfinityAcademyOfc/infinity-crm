...
const DocumentExplorerContent: React.FC<DocumentExplorerProps> = ({ onSelectFile, selectedFile }) => {
  ...
  const { newItemDialogOpen, setNewItemDialogOpen, handleAddItem, handleCreateItem, handleDeleteItem, handleRename, handleExportDocument, toggleFolderExpanded } = useDocumentOperations(onSelectFile);
