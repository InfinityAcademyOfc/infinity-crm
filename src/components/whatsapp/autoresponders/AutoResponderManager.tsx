...
const AutoResponderManager = () => {
  ...
  // Fetch autoResponders from Supabase
  useEffect(() => {
    const fetchAutoResponders = async () => {
      try {
        ...
        toast({
          ...
          description: "Não foi possível carregar as respostas automáticas. Tente novamente.",
          variant: "destructive"
        });
      } finally {
        setIsLoading(false);
    ...
    // Set up real-time listener for autoResponders updates
  ...
  const handleDeleteAutoResponder = async (id: string) => {
    try {
      ...
      toast({
        title: "Resposta automática excluída",
        description: "A resposta automática foi excluída com sucesso."
      });
    } catch (error) {
      console.error("Error deleting auto responder:", error);
      toast({
        title: "Erro ao excluir resposta automática",
        description: "Não foi possível excluir a resposta automática. Tente novamente.",
        variant: "destructive"
      });
    }
  };
