  ...
  <NavLink
    ...
    className={({ isActive }) =>
      cn(
        ...
        isActive 
          ? "bg-primary text-primary-foreground shadow-sm before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-8 before:w-1 before:rounded-full before:bg-primary-foreground before:opacity-50 hover:bg-primary/90" 
